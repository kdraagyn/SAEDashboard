...
def compileGauges():
	...
	gauges.append(barGauge(530, 500, 250, 50, "0CFFF048", "0CFFF050", padding=20, color=programConfig.barColor, fontcolor=programConfig.fontColor))
	gauges.append(barGauge(50,100, 50, 250, "0CFFF048", "0CFFF050", orientation=barGauge.VERTICAL, padding=20, color=programConfig.barColor, fontcolor=programConfig.fontColor))
